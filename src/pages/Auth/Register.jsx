...
const Register = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (registry.find(u => u.email === formData.email.trim().toLowerCase())) {
        ...
        login({ name: newUser.name, email: newUser.email, phone: newUser.phone, role: newUser.role });
                ...
                <div className="p-10 md:p-16 flex flex-col justify-center">
                    <div className="flex flex-col gap-7">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                            ...
                            <button
                                type="submit"
                                className="bg-primary text-white py-5 rounded-2xl font-black uppercase text-xs tracking-widest shadow-2xl shadow-primary/20 hover:-translate-y-1 transition-all flex items-center justify-center gap-3 mt-2"
                            >
